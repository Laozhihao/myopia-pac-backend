...
public class StatFacade {
    ...
    private void schoolStatistics(List<StatConclusion> statConclusions,
        ...
        List<ScreeningPlanSchoolStudent> planSchoolStudents = screeningPlanSchoolStudentService.getSomeInfoByScreeningPlanIds(Lists.newArrayList(screeningPlanIds));
