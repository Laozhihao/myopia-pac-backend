...
public class ArchiveRecDataBuilder {
    ...
    private List<QesFieldDataBO> setComputerOptometry(CommonDiseaseArchiveCard commonDiseaseArchiveCard){
        ...
        qesFieldDataBOList.add(new QesFieldDataBO("SER", AnswerUtil.numberFormat(SEUtil.getSphericalEquivalent(rightSph,rightCyl),3)));
        ...
        qesFieldDataBOList.add(new QesFieldDataBO("SEL",AnswerUtil.numberFormat(SEUtil.getSphericalEquivalent(leftSph,leftCyl),3)));
