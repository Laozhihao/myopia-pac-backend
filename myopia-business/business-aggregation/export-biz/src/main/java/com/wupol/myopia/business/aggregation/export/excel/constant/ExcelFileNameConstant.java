...
public class ExcelFileNameConstant {
     ...
     * 医院 Excel 文件名
     */
    public final String HOSPITAL_EXCEL_FILE_NAME = "%s医院数据表";
     ...
     * 筛查人员 Excel 文件名
     */
    public final String STAFF_EXCEL_FILE_NAME = "%s筛查机构人员数据表";

    /**
     * 学生 Excel 文件名
     */
    public final String STUDENT_EXCEL_FILE_NAME = "%s%s%s学生数据表";
     ...
     * 学校名称
     */
    public final String SCHOOL_NAME = "学校-";

    /**
     * 筛查机构人员名称
     */
    public final String STAFF_NAME = "筛查机构人员-";
