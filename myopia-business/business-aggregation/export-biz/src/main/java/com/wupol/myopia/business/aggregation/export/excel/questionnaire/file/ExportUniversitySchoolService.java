...
public class ExportUniversitySchoolService implements QuestionnaireExcel {
    ...
    public void generateExcelFile(ExportCondition exportCondition,String fileName) throws IOException {
        ...
        if (CollectionUtils.isEmpty(userQuestionRecordList)){
            log.info("暂无数据：notificationId:{}、planId:{}、taskId:{},问卷类型：{}",exportCondition.getNotificationId(),exportCondition.getPlanId(),exportCondition.getTaskId(),QuestionnaireTypeEnum.UNIVERSITY_SCHOOL.getDesc());
            return;
        }
