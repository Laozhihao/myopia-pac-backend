 ...
 * @author Simple4H
 */
@Service(ExportExcelServiceNameConstant.SCHOOL_STUDENT_EXCEL_SERVICE)
@Log4j2
    ...
    public List getExcelData(ExportCondition exportCondition) {
        ...
        for (SchoolStudent item : studentLists) {
            ...
            StudentExportDTO exportVo = new StudentExportDTO()
                    ...
                    .setQuestionCount(questionRecordMap.getOrDefault(item.getStudentId(), 0L))
                    ...
                    .setCredential(MaskUtil.maskCredential(item.getIdCard(), item.getPassport()));
