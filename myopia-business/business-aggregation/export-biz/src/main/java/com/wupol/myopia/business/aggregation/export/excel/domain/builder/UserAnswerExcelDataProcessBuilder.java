 ...
 */
@UtilityClass
public class UserAnswerExcelDataProcessBuilder {
     ...
     */
    public Map<String, List<QuestionnaireRecDataBO>> getExcelData(List<UserQuestionnaireAnswerBO> userQuestionnaireAnswerBOList,
