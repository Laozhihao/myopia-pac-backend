...
public class VisionScreeningDataServiceImpl implements IScreeningDataService {
    ...
    private void genReScreeningData(Map<Integer, StatConclusionExportDTO> rescreenPlanStudentIdDTOMap, StatConclusionExportDTO dto, VisionScreeningResultExportDTO exportDTO) {
        ...
        if (Objects.nonNull(rescreenVo)) {
            ...
            exportDTO.setLeftReScreenK1(ScreeningDataFormatUtils.generateComputerOptometrySingleSuffixDStr(JSONPath.eval(rescreenVo, ScreeningResultPahtConst.LEFT_EYE_K1)));
            exportDTO.setLeftReScreenK2(ScreeningDataFormatUtils.generateComputerOptometrySingleSuffixDStr(JSONPath.eval(rescreenVo, ScreeningResultPahtConst.LEFT_EYE_K2)));
            exportDTO.setRightReScreenK1(ScreeningDataFormatUtils.generateComputerOptometrySingleSuffixDStr(JSONPath.eval(rescreenVo, ScreeningResultPahtConst.RIGHT_EYE_K1)));
            exportDTO.setRightReScreenK2(ScreeningDataFormatUtils.generateComputerOptometrySingleSuffixDStr(JSONPath.eval(rescreenVo, ScreeningResultPahtConst.RIGHT_EYE_K2)));
        }
    }
