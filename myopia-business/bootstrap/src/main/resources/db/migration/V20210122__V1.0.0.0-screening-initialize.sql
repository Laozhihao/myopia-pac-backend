...
(
    ...
    `error_ratio`           decimal(5,2) NOT NULL DEFAULT '0' COMMENT '监测情况--筛查错误率（默认0，单位%）',
...
(
    ...
    `avg_left_vision`          decimal(3,1) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--平均左眼视力（小数点后一位，默认0.0）',
    `avg_right_vision`         decimal(3,1) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--平均右眼视力（小数点后一位，默认0.0）',
    `low_vision_numbers`       int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--视力低下人数（默认0）',
    `low_vision_ratio`         decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--视力低下比例（均为整数，如10.01%，数据库则是1001）',
    `wearing_glasses_numbers`  int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--戴镜人数（默认0）',
    `wearing_glasses_ratio`    decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--戴镜人数（均为整数，如10.01%，数据库则是1001）',
    `myopia_numbers`           int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--近视人数（默认0）',
    `myopia_ratio`             decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--近视比例（均为整数，如10.01%，数据库则是1001）',
    `ametropia_numbers`        int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--屈光不正人数（默认0）',
    `ametropia_ratio`          decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--屈光不正比例（均为整数，如10.01%，数据库则是1001）',
    `vision_label0_numbers`    int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--零级预警人数（默认0）',
    `vision_label0_ratio`      decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--零级预警比例（均为整数，如10.01%，数据库则是1001）',
    `vision_label1_numbers`    int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--一级预警人数（默认0）',
    `vision_label1_ratio`      decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--一级预警比例（均为整数，如10.01%，数据库则是1001）',
    `vision_label2_numbers`    int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--二级预警人数（默认0）',
    `vision_label2_ratio`      decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--二级预警比例（均为整数，如10.01%，数据库则是1001）',
    `vision_label3_numbers`    int(10) NOT NULL DEFAULT '0' COMMENT '视力情况--三级预警人数（默认0）',
    `vision_label3_ratio`      decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--三级预警比例（均为整数，如10.01%，数据库则是1001）',
    ...
    `treatment_advice_ratio`   decimal(5,2) NOT NULL DEFAULT '0' COMMENT '视力情况--建议就诊比例（均为整数，如10.01%，数据库则是1001）',
...
(
    ...
    `school_name`              varchar(50) NOT NULL DEFAULT '' COMMENT '视力情况--学校名',
    `screening_org_id`         int(10) unsigned NOT NULL COMMENT '视力情况--筛查机构名字',
    `screening_org_name`       varchar(50) NOT NULL DEFAULT '' COMMENT '视力情况-筛查机构名',
    `screening_notice_id`      int(10) unsigned NOT NULL COMMENT '视力情况--所属的通知id',
    ...
    `avg_right_vision`         decimal(3,1) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--平均右眼视力（小数点后一位，默认0.0）',
    `low_vision_numbers`       int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--视力低下人数（默认0）',
    `low_vision_ratio`         decimal(5,2) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--视力低下比例（均为整数，如10.01%，数据库则是1001）',
    `wearing_glasses_numbers`  int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--戴镜人数（默认0）',
    `wearing_glasses_ratio`    decimal(5,2) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--戴镜人数（均为整数，如10.01%，数据库则是1001）',
    `myopia_numbers`           int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--近视人数（默认0）',
    `myopia_ratio`             decimal(5,2) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--近视比例（均为整数，如10.01%，数据库则是1001）',
    `ametropia_numbers`        int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--屈光不正人数（默认0）',
    `ametropia_ratio`          decimal(5,2) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--屈光不正比例（均为整数，如10.01%，数据库则是1001）',
    `vision_label0_numbers`    int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--零级预警人数（默认0）',
    ...
    `key_warning_numbers`      int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--重点视力对象数量（默认0）',
    `treatment_advice_numbers` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--建议就诊数量（默认0）',
    `treatment_advice_ratio`   decimal(5,2) unsigned NOT NULL DEFAULT '0' COMMENT '视力情况--建议就诊比例（均为整数，如10.01%，数据库则是1001）',
...
CREATE TABLE `m_school_monitor_statistic` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `school_name` varchar(255) DEFAULT NULL COMMENT '监测情况--学校名字',
    `finish_ratio` decimal(5,2) NOT NULL COMMENT '监测情况---完成率',
    `school_type` int(10) unsigned NOT NULL COMMENT '监测情况--学校类型',
    `school_id` int(10) unsigned NOT NULL COMMENT '监测情况--学校id',
    `screening_org_name` varchar(64) NOT NULL COMMENT '监测情况--筛查机构名字',
