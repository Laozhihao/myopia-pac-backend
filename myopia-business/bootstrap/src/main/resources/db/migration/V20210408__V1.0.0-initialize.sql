...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '医院-学生' ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_district_big_screen_statistic`  (
  ...
  `update_time` timestamp(0) DEFAULT CURRENT_TIMESTAMP COMMENT '大屏展示--更新时间',
...
INSERT INTO m_school (id, school_no, create_user_id, gov_dept_id, district_id, district_detail, name, kind, kind_desc, lodge_status, type, province_code, city_code, area_code, town_code, address, remark, status, create_time, update_time)
VALUES (1, '1234567890', 1, 1, 1919, '[{"id":1918,"name":"广东省","code":440000000,"parentCode":100000000,"areaCode":null,"monitorCode":null,"child":null},{"id":1919,"name":"广州市","code":440100000,"parentCode":440000000,"areaCode":null,"monitorCode":null,"child":null}]', '其他', 2, '其他', null, 7, null, null, null, null, '', '', 0, '2021-03-01 14:19:06', '2021-03-01 14:19:06');
