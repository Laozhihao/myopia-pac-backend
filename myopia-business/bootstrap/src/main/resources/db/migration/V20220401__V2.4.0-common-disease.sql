...
ALTER TABLE m_vision_screening_result ADD deviation_data json NULL COMMENT '晒出不准确说明';
ALTER TABLE m_screening_plan_school_student ADD state tinyint(1) NOT NULL default 0 COMMENT '未做检查说明';
