...
(
    ...
    mac_addr    varchar(32)                         not null comment 'mac地址',
...
create index h_image_detail_create_time_hospital_id_patient_id_index
    on h_image_detail (create_time, hospital_id, patient_id);
