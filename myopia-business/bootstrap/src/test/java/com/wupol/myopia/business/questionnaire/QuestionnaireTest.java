...
public class QuestionnaireTest {
    ...
    public void questionnaireBaseInfoDataTest(){
        ...
        List<QuestionnaireQuestionDataBO> dataBuildList = questionnaireFacade.getDataBuildList(questionnaireIds);
        for (QuestionnaireQuestionDataBO questionnaireQuestionDataBO : dataBuildList) {
            System.out.println(JSON.toJSONString(questionnaireQuestionDataBO, true));
        }
