...
@AllArgsConstructor
@NoArgsConstructor
public class MonthAgeStatusDTO implements Serializable {
    ...
    public MonthAgeStatusDTO(MonthAgeEnum monthAgeEnum, Integer status) {
        this.monthAge = monthAgeEnum.getId();
        this.name = monthAgeEnum.getName();
        this.status = status;
    }
