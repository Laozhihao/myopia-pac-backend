...
public interface ScreeningPlanMapper extends BaseMapper<ScreeningPlan> {
    ...
    IPage<ScreeningPlanResponseDTO> getPlanLists(@Param("page") Page<?> page, @Param("ids") List<Integer> ids, @Param("needFilterAbolishPlan") boolean needFilterAbolishPlan, @Param("bindOrgIds") List<Integer> bindOrgIds, @Param("schoolId") Integer schoolId);
