...
public class SchoolResultTemplateExcel {
    ...
    private final static String TITLE = "表格填写说明\n" +
            "1、戴镜情况选项为 佩戴眼镜、不戴镜、隐形眼镜、夜戴角膜塑形镜；其他文本将不会导入系统中\n" +
            ...
            "8、 视力检查、电脑验光、升高、体重 数据请填写数值，不带对应的单位，系统默认单位：视力检查（5分记录法）、电脑验光（球镜/柱镜：屈光度 D；轴位：度 °）、身高（厘米CM）、体重（千克KG）\n" +
            "9、 视力检查、电脑验光、升高、体重 请严格按照填写数值规范填写，如果不符合规范导致无法解析，该数值将被默认为无数据\n" +
            "10、如果该学生已有数据，导入表格中同样检查项存在数据，则使用表格中的数据覆盖原有数据\n" +
            "11、如果该学生已有数据，导入表格中同样检查项无数据，则使用原有数据。\n" +
            "12、请不要修改模板表格中默认导出的数据，如果改动可能会导致查找学生失败导致导入失败\n" +
            "===============================================================================================================================================\n" +
            "数据覆盖例子：\n" +
            "A： 系统中原有数据：        裸眼（右）5.0 、裸眼（左）      、球镜（右）0.00     、球镜（左）        、球镜（左）-10.00 、球镜（左）        、升高 175 、 体重 60\n" +
            "B ：表格中数据：                裸眼（右）5.0 、裸眼（左）4.9  、球镜（右）-10.00 、球镜（左）-2.00 、球镜（左）           、球镜（左）-2.00、升高 178 、 体重 50\n" +
            "C ：导入完成后最终数据：裸眼（右）5.0 、裸眼（左）4.9  、球镜（右）-10.00 、 球镜（左）-2.00 、球镜（左）-10.00 、球镜（左）-2.00、升高 178 、 体重 50";
