...
public class SchoolResultTemplateExcel {
    ...
    private final static String TITLE = "表格填写说明\n" +
            ...
            "===============================================================================================================================================\n" +
            "数据覆盖例子：\n" +
            "A：系统中原有数据：          裸眼（右）5.0、  裸眼（左）、     球镜（右）0.00、    球镜（左）、      球镜（右）-10.00 、  球镜（左） 、      身高 175 、 体重 60\n" +
            "B：表格中数据：             裸眼（右）5.0、  裸眼（左）4.9、  球镜（右）-10.00、  球镜（左）-2.00、 球镜（右）、         球镜（左）-2.00、  身高 178 、 体重 50\n" +
            "C：导入完成后最终数据：      裸眼（右）5.0 、 裸眼（左）4.9、  球镜（右）-10.00、  球镜（左）-2.00、 球镜（左）-10.00、   球镜（左）-2.00、  身高 178、  体重 50";
