...
public enum ScreeningDoctorAdviceEnum {
    ...
    SUGGEST_CONTENT_7(Boolean.TRUE, "戴镜视力下降。建议及时到医疗机构复查，确定是否需要更换眼镜", 2),
    SUGGEST_CONTENT_8(Boolean.FALSE, "戴镜视力正常。建议3个月或半年1次检查裸眼视力和戴镜视力", 0),
    SUGGEST_CONTENT_9(Boolean.TRUE, "裸眼视力下降，视功能可能异常。建议到医疗机构接受散瞳光检查，明确诊断并采取措施。", 2),
    SUGGEST_CONTENT_10(Boolean.FALSE, "远视储备不足，有发生近视的可能性，需进一步检查，改变不良用眼行为", 1),
    SUGGEST_CONTENT_11(Boolean.TRUE, "裸眼视力下降，合并较为明显的屈光不正或眼病。建议到医疗机构明确诊断及时矫治疗。", 2);
