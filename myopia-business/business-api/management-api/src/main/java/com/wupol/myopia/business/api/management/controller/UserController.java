...
public class UserController {
    ...
    public UserVO getUserDetailByUserId(@PathVariable("userId") Integer userId) {
        ...
        if (SystemCode.SCHOOL_CLIENT.getCode().equals(user.getSystemCode())) {
            School school = schoolService.getBySchoolId(user.getOrgId());
            return userVO.setOrgName(school.getName())
                    .setIsIndependentScreening(school.getIsIndependentScreening())
                    .setDistrictDetail(districtService.getDistrictPositionDetailById(school.getDistrictId())).setDataSubmitConfig(school.getDataSubmitConfig());
        }
