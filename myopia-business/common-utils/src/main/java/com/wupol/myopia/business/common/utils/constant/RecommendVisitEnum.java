...
public enum RecommendVisitEnum {
    ...
    MIDDLE_RESULT_1(5, true, "裸眼远视力下降，戴镜远视力下降。建议：请及时到医疗机构复查。"),
    MIDDLE_RESULT_2(6, false, "裸眼远视力下降，戴镜远视力≥4.9。建议：请3个月或半年1次检查裸眼视力和戴镜视力。"),
    MIDDLE_RESULT_3(7, true, "裸眼远视力下降，视功能可能异常。建议：请到医疗机构接受检查，明确诊断并及时采取措施。"),
    MIDDLE_RESULT_4(8, true, "裸眼视力下降，合并较为明显的屈光不正或眼病。建议：到医疗机构明确诊断及时矫治疗。"),
    MIDDLE_RESULT_5(9, false, "裸眼远视力≥4.9，目前尚无近视高危因素。建议：6～12 个月复查。"),
    MIDDLE_RESULT_6(10, true, "裸眼远视力≥4.9，目前尚 无近视高危因素。但远视度数较高，可能存在远视高位因素。建议：建议请到医疗机构接受检查。"),
