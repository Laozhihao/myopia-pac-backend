...
public class QrcodeUtil {
    ...
    public  static String getQrCodeContent(Integer planId, Integer planStudentId,
                                    String name,Integer age,Integer gender,
                                    String parentPhone,String schoolName,String gradeName,String className,String idCard, Integer type) {
        if (CommonConst.EXPORT_SCREENING_QRCODE.equals(type)) {
            ...
            return setVs666QrCodeRule(planId, planStudentId,
                    name,age,gender,parentPhone,schoolName,gradeName,className,idCard);
        }
    ...
    public static String setVs666QrCodeRule(Integer planId, Integer planStudentId,
                                     String name,Integer age,Integer gender,
                                     String parentPhone,String schoolName,String gradeName,String className,String idCard) {
        return String.format(QrCodeConstant.VS666_QR_CODE_CONTENT_FORMAT_RULE,
                ...
                StringUtils.getDefaultIfBlank(schoolName, "null"),
                StringUtils.isEmpty(gradeName) ? "null" : gradeName + className,
