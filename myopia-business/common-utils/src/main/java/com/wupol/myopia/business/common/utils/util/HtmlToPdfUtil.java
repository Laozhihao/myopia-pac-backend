...
public class HtmlToPdfUtil {
    ...
    public static boolean convertArchives(String htmlSrcPath, String pdfFilePath) {
        // "--window-status 1" 允许js异步请求
        String[] command = {HTML_TO_PDF_TOOL_COMMAND, "-L", "0", "-R", "0", "-T", "0", "-B", "0", "--disable-smart-shrinking", "--debug-javascript", "--javascript-delay 1000", "--no-stop-slow-scripts", "--window-status", "1", htmlSrcPath, pdfFilePath};
        return convert(htmlSrcPath, pdfFilePath, 0, command);
    }
