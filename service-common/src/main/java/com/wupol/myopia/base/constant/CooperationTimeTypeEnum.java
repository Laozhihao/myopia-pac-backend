...
public enum CooperationTimeTypeEnum {
    ...
    COOPERATION_TIME_TYPE_CUSTOMIZE(-1, "自定义"), COOPERATION_TIME_TYPE_30_DAY(0, "30天"), COOPERATION_TIME_TYPE_60_DAY(1, "60天"), COOPERATION_TIME_TYPE_180_DAY(2, "180天"), COOPERATION_TIME_TYPE_1_YEAR(3, "1年"), COOPERATION_TIME_TYPE_2_YEAR(4, "2年"), COOPERATION_TIME_TYPE_3_YEAR(5, "3年");
    ...
    public static String getCooperationTimeTypeDesc(Integer cooperationTimeType, Date cooperationStartTime, Date cooperationEndTime) {
        if (COOPERATION_TIME_TYPE_CUSTOMIZE.getType().equals(cooperationTimeType)) {
            return CooperationTypeEnum.getCooperationTypeName(cooperationTimeType) + " " + DateUtil.betweenDay(cooperationStartTime, cooperationEndTime) + "天";
        } else {
            return CooperationTypeEnum.getCooperationTypeName(cooperationTimeType) + " " + CooperationTimeTypeEnum.getCooperationTimeTypeName(cooperationTimeType);
        }
    }
}
