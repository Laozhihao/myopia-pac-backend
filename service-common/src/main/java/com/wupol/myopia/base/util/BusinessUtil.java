...
public class BusinessUtil {
    ...
    public static boolean checkCooperation(Integer cooperationType, Integer cooperationTimeType, Date cooperationStartTime,
        ...
        return cooperationStartTime.getTime() <= cooperationEndTime.getTime();
    }
    ...
    public static List<Integer> getCanCheckMonthAgeByDate(Date birthday) {
        ...
        if (years > 6 || (years == 6 && (months > 0 || days > 0))) {
            return Collections.singletonList(MonthAgeEnum.YEAR6.getId());
            ...
            return Collections.singletonList(MonthAgeEnum.MONTH18.getId());
            ...
            return Collections.singletonList(MonthAgeEnum.MONTH12.getId());
            ...
            // 7月龄15天＜*≤8月龄15天：【8月龄】
            return Collections.singletonList(MonthAgeEnum.MONTH8.getId());
            ...
            // 5月龄15天＜*≤6月龄15天：【6月龄】
            return Collections.singletonList(MonthAgeEnum.MONTH6.getId());
            ...
            // 2月龄15天＜*≤3月龄15天：【3月龄】
            return Collections.singletonList(MonthAgeEnum.MONTH3.getId());
            ...
            // 15天＜*≤45天：【满月】
            return Collections.singletonList(MonthAgeEnum.MONTH1.getId());
        } else {
            // 0＜*≤15天：【新生儿】
            return Collections.singletonList(MonthAgeEnum.NB.getId());
        }
    }
