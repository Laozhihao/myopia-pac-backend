...
public final class RedisConstant {
     ...
     */
    public static final String USER_PERMISSION_KEY = "auth:user:permission:%d";

    /**
     * 用户授权token，auth:user:authorization:{userId}，如：auth:user:authorization:24
     */
    public static final String USER_AUTHORIZATION_KEY = "auth:user:authorization:%d";
    /**
     * 用户旧的授权token，auth:user:authorization_old:{userId}，如：auth:user:authorization_old:24
     */
    public static final String USER_AUTHORIZATION_OLD_KEY = "auth:user:authorization_old:%d";
