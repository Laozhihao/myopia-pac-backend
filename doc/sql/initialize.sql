...
CREATE TABLE `m_screening_plan_school_student`  (
  ...
  `id_card` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci default NULL COMMENT '筛查计划--参与筛查的学生身份证号码',
  ...
  `student_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci default NULL COMMENT '筛查计划--参与筛查的学生编号',
  `student_name` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci default NULL COMMENT '筛查计划--参与筛查的学生名字',
  ...
  `mock_status`   tinyint  default 0  NOT NULL comment 'mock状态, 0mock, -1 非mock',
...
CREATE TABLE `m_vision_screening_result`  (
  ...
  `ocular_inspection_data` json DEFAULT NULL COMMENT '筛查结果--33cm眼位',
  `eye_pressure_data` json DEFAULT NULL COMMENT '筛查结果--眼压',
  `fundus_data` json DEFAULT NULL COMMENT '筛查结果--眼底',
  `slit_lamp_data` json DEFAULT NULL COMMENT '筛查结果--裂隙灯检查',
  `pupil_optometry_data` json DEFAULT NULL COMMENT '筛查结果--小瞳验光',
  `visual_loss_level_data` json DEFAULT NULL COMMENT '筛查结果--盲及视力损害分类',
  `systemic_disease_symptom` varchar(500) DEFAULT NULL COMMENT '筛查结果--全身疾病在眼部的表现',
...
CREATE TABLE `m_device_screening_data`  (
  ...
  `left_axsi` decimal(7, 3) NULL DEFAULT NULL COMMENT '左眼轴位',
  `right_axsi` decimal(7, 3) NULL DEFAULT NULL COMMENT '右眼轴位',
  `left_pr` decimal(7, 3) NULL DEFAULT NULL COMMENT '左眼瞳孔半径',
  `right_pr` decimal(7, 3) NULL DEFAULT NULL COMMENT '右眼瞳孔半径',
  `left_pa` decimal(7, 3) NULL DEFAULT NULL COMMENT '左眼等效球镜度',
  `right_pa` decimal(7, 3) NULL DEFAULT NULL COMMENT '右眼等效球镜度',
  `left_sph` decimal(7, 3) NULL DEFAULT NULL COMMENT '左眼球镜',
  `right_sph` decimal(7, 3) NULL DEFAULT NULL COMMENT '右眼球镜',
  `pd` decimal(7, 3) NULL DEFAULT NULL COMMENT '瞳距',
