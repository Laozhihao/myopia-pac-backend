package com.wupol.myopia.rec.util;
...
public class TypeUtils {
    ...
    public Object getObject(Type type, String data) throws JsonProcessingException {
        ...
        if (type instanceof ParameterizedTypeImpl) {
            ...
            Type genericType = Arrays.stream(actualTypeArguments).findFirst().orElseThrow(()-> new RuntimeException("参数为空,type = " + JSON.toJSONString(type)));
            Class<?> genericClass;
            try {
